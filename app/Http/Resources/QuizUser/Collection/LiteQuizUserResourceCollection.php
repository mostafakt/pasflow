...
use App\Http\Resources\QuizUser\Item\LiteQuizUserResource;
...
class LiteQuizUserResourceCollection extends ApiResourceCollection
{
   public function __construct($resource)
   {
       parent::__construct($resource,LiteQuizUserResource::class);
   }
}
